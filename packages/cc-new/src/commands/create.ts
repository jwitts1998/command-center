...
async function cloneTemplate(templateUrl: string, targetDir: string): Promise<void> {
...
async function customizeTemplate(config: ProjectConfig): Promise<void> {
  // Update CLAUDE.md
